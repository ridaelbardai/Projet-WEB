		...
		<section class="footer-top padding-y">
			<div class="row">
				<aside class="col-md-4">
					<article class="mr-3">
						<img src="https://www.fstm.ac.ma/images/logo.png" class="logo-footer" height="40">
				...
				<aside class="col-sm-2  col-md-2">
					...
					<a href="#" class="d-block mb-2"><img src="http://assets.stickpng.com/thumbs/5a902db97f96951c82922874.png" height="70"></a>
					<a href="#" class="d-block mb-2"><img src="http://assets.stickpng.com/images/5a902dbf7f96951c82922875.png" height="30"></a>
				</aside>
			</div> <!-- row.// -->
		</section>	<!-- footer-top.// -->
